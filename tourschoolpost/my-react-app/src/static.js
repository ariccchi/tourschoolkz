...
function Static() {
    ...
    useEffect(() => {
        const fetchData2 = async () => {
            try {
                const response2 = await axios.get('http://localhost:8888/tourschoolphp/staticapplication.php');
        ...
        const fetchData = async () => {
            try {
                const response = await axios.get('http://localhost:8888/tourschoolphp/staticlanduser.php');
        ...
        const fetchData3 = async () => {
            try {
                const response3 = await axios.get('http://localhost:8888/tourschoolphp/staticsuccessaplication.php');
